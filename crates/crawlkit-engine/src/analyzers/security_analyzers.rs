...
mod tests {
    ...
    use crate::analyzers::{
        CookieAnalyzer, FormLabelAnalyzer, HeadingOrderAnalyzer, ImageAccessibilityAnalyzer,
        LandmarkRegionsAnalyzer, LinkAccessibilityAnalyzer, TableAccessibilityAnalyzer,
    };
