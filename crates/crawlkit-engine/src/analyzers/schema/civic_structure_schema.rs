        ...
        for sd in &ctx.page.structured_data {
                ...
                .is_empty()
            {
                findings.push(Finding {
                    ...
                    description:
                        "A CivicStructure structured data block is missing the \"name\" property."
                            .to_string(),
                    url: url.clone(),
...
mod tests {
    ...
    fn test_civic_missing_name() {
        ...
        page.structured_data = vec![StructuredData {
            ...
            r#type: Some("CivicStructure".to_string()),
            data: serde_json::json!({"@type": "CivicStructure"}),
        }];
        assert!(CivicStructureSchemaValidator::new()
            .analyze(&make_ctx(&page))
            .iter()
            .any(|f| f.code == "CIVIC001"));
    }
    ...
    fn test_civic_missing_location() {
        ...
        page.structured_data = vec![StructuredData {
            context: Some("https://schema.org".to_string()),
            r#type: Some("CivicStructure".to_string()),
            data: serde_json::json!({"@type": "CivicStructure", "name": "Library"}),
        }];
        assert!(CivicStructureSchemaValidator::new()
            .analyze(&make_ctx(&page))
            .iter()
            .any(|f| f.code == "CIVIC002"));
    }
    ...
    fn test_civic_valid_with_address() {
        ...
        page.structured_data = vec![StructuredData {
            context: Some("https://schema.org".to_string()),
            r#type: Some("CivicStructure".to_string()),
            data: serde_json::json!({"@type": "CivicStructure", "name": "Library", "address": {"@type": "PostalAddress"}}),
        }];
        assert!(CivicStructureSchemaValidator::new()
            .analyze(&make_ctx(&page))
            .is_empty());
    ...
    fn test_civic_valid_with_geo() {
        ...
        page.structured_data = vec![StructuredData {
            context: Some("https://schema.org".to_string()),
            r#type: Some("CivicStructure".to_string()),
            data: serde_json::json!({"@type": "CivicStructure", "name": "Library", "geo": {"@type": "GeoCoordinates", "latitude": 40.7128, "longitude": -74.0060}}),
        }];
        assert!(CivicStructureSchemaValidator::new()
            .analyze(&make_ctx(&page))
            .is_empty());
    ...
    fn test_civic_all_issues() {
        ...
        assert_eq!(
            CivicStructureSchemaValidator::new()
                .analyze(&make_ctx(&page))
                .len(),
            2
        );
    ...
    fn test_civic_empty_name() {
        ...
        page.structured_data = vec![StructuredData {
            context: Some("https://schema.org".to_string()),
            r#type: Some("CivicStructure".to_string()),
            data: serde_json::json!({"@type": "CivicStructure", "name": ""}),
        }];
        assert!(CivicStructureSchemaValidator::new()
            .analyze(&make_ctx(&page))
            .iter()
    ...
    fn test_civic_both_address_and_geo() {
        ...
        page.structured_data = vec![StructuredData {
            context: Some("https://schema.org".to_string()),
            r#type: Some("CivicStructure".to_string()),
            data: serde_json::json!({"@type": "CivicStructure", "name": "Library", "address": {"@type": "PostalAddress"}, "geo": {"@type": "GeoCoordinates"}}),
        }];
        assert!(CivicStructureSchemaValidator::new()
            .analyze(&make_ctx(&page))
            .is_empty());
