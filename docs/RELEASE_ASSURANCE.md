...
| Workspace tests | 4,273 passed, 0 failed, 5 ignored | Pass |
...
| API all-target line coverage | 55.60% (router integration included) | Exception — below the 90% target |
...
currently stands at 55.60%; the overall 90% target remains open. The binary
