...
| Workspace tests | 4,287 passed, 0 failed, 5 ignored | Pass |
...
| API all-target line coverage | 64.14% (router integration included) | Exception — below the 90% target |
...
currently stands at 64.14%; the overall 90% target remains open. The binary
