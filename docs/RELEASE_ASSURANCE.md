...
| Workspace tests | 4,298 passed, 0 failed, 5 ignored | Pass |
...
| API all-target line coverage | 68.63% (router integration included) | Exception — below the 90% target |
...
currently stands at 68.63%; the overall 90% target remains open. The binary
