...
mod tests {
    ...
    use crate::analyzers::{
        ContentSecurityPolicyAnalyzer, CrossOriginResourcePolicyAnalyzer, MixedContentAnalyzer,
        ReferrerPolicyAnalyzer, XContentTypeOptionsAnalyzer, XFrameOptionsAnalyzer,
...
mod new_analyzer_tests {
    use super::*;
    use crate::analyzers::{CookieHttpOnlyFlagValidator, CookieSecureFlagValidator};
    use crate::meta::MetaTags;
