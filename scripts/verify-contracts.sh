...
cargo test -p crawlkit-engine --test storage_contract_tests -- --test-threads="$threads"
cargo test -p crawlkit-engine --test queue_contract_tests -- --test-threads="$threads"
cargo test -p crawlkit-engine --test analyzer_registry_contract_tests -- --test-threads="$threads"
cargo test -p crawlkit --test cli_tests -- --test-threads="$threads"
