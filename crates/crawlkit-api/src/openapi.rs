...
#[openapi(
    ...
    paths(
        ...
        crate::handlers::ga4::delete_ga4_credentials,
        crate::handlers::ga4::exchange_ga4_code,
        crate::handlers::ga4::ga4_integration_status,
        crate::handlers::ga4::run_ga4_report,
        crate::handlers::ga4::store_ga4_credentials,
        ...
        crate::handlers::marketplace::rate_plugin,
        crate::handlers::marketplace::track_plugin_download,
        crate::handlers::marketplace::verify_marketplace_plugin,
    ...
    components(
        schemas(
            ...
            crate::types::Ga4ExchangeRequest,
            crate::types::Ga4ReportRequestBody,
            crate::types::Ga4ReportResponse,
            crate::types::Ga4RowDto,
            crate::types::Ga4StatusResponse,
            crate::types::HealthResponse,
            crate::types::LoginRequest,
            crate::types::MarketplacePlugin,
            crate::types::PluginDownloadResponse,
            crate::types::PluginRating,
            crate::types::PluginRatingResponse,
            crate::types::PluginSearchQuery,
    ...
    tags(
        ...
        (name = "integrations", description = "Per-tenant external-service connectors (GA4) with encrypted credential storage"),
