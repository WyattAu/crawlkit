...
| Workspace tests | 4,295 passed, 0 failed, 5 ignored | Pass |
...
| API all-target line coverage | 66.51% (router integration included) | Exception — below the 90% target |
...
currently stands at 66.51%; the overall 90% target remains open. The binary
