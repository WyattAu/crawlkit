...
test-integration:
    cargo test --workspace --test integration_tests --test backlink_integration_tests --test playwright_integration_tests --test rum_integration_tests --test property_tests --test wasm_abi_tests --test plugin_index_tests --test router_tests
