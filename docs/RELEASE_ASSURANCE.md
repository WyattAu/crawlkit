...
| Workspace tests | 4,278 passed, 0 failed, 5 ignored | Pass |
...
| API all-target line coverage | 60.38% (router integration included) | Exception — below the 90% target |
...
currently stands at 60.38%; the overall 90% target remains open. The binary
