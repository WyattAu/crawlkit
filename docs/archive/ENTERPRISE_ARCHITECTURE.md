...
> **Archived (2026-08-26)**: This document was a proposed architecture from 2026-07-24 that was never fully implemented. RS256 JWT, SAML, and billing were never built. The actual implementation uses HS256 JWT and OIDC. Kept for historical reference only.
